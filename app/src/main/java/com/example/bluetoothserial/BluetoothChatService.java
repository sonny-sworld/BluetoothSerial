...
//	 UUID.fromString("fa87c0d0-afac-11de-8a39-0800200c9a66");
	...
	private int mState;
	private MicrochipIntentService callBack;
	...
	public BluetoothChatService(Context context) {
		...
		mState = STATE_NONE;
		if(context instanceof MicrochipIntentService){
			callBack = (MicrochipIntentService) context;
		}
	...
	private synchronized void setState(int state) {
		 ...
		 * mHandler.obtainMessage(DOPrinterDemoActivity.MESSAGE_STATE_CHANGE,
	...
	public synchronized void connect(BluetoothDevice device) {
		...
		// bundle.putString(DOPrinterDemoActivity.DEVICE_NAME,
		// device.getName());
		// msg.setData(bundle);
		// msg.sendToTarget();
	...
	private void connectionFailed() {
		 ...
		 * mHandler.obtainMessage(DOPrinterDemoActivity.MESSAGE_TOAST); Bundle
		 * bundle = new Bundle(); bundle.putString(DOPrinterDemoActivity.TOAST,
...
//	                break;
		...
		public void write(byte[] buffer) {
			try {
				 ...
				 * mHandler.obtainMessage(DOPrinterDemoActivity.MESSAGE_WRITE,
